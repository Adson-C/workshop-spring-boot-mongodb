package com.adson.workshopmongo.config;
...
import com.adson.workshopmongo.dto.AuthorDTO;
import com.adson.workshopmongo.dto.CommentDTO;
import com.adson.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2021"), "Partiu viagem", "Vou viajar para SP abraços!",
				new AuthorDTO(maria));
